...
#       Help buttons on FineTune() three button bars. Link to:
# https://www.pippim.com/programs/mserve.html#fine-tune-time-synchronization
# https://www.pippim.com/programs/mserve.html#begin-sync-option
# https://www.pippim.com/programs/mserve.html#sample-all-option

#       Use new button names "HelpT", "HelpB" and "HelpS"  Note these 'id'
#           tags are system generated by TOC maker. Use custom 'id' tags
...
0x04832219  0 0        N/A Kid3 is running
    ...
    def show_debug(self):
        ...
        if self.fine_tune and self.fine_tune.sync_ctl.metadata is not None:
            print("\nLast file accessed - 'ffprobe', "
                  "'(self.fine_tune.sync_ctl.metadata):")
            print("-" * 68 + "\n")
            for i in self.fine_tune.sync_ctl.metadata:
                print(i, ":", self.fine_tune.sync_ctl.metadata[i])
    ...
    def play_one_song(self, resume=False, chron_state=None, real_start=True):
        ...
        if resume:
            # If woken up from system sleep or reboot. Restore song at save point.
            # May 29, 2023 - When resuming buttons do not have art color assigned
